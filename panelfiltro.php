<div class="card filtro">
  ...
  <div class="card-body">
   <form action="confirmalogalu.php?go=2" method="post">
       <div class="row">  
       <div class="col-sm-6 col-md-6">
            ...
            <div class="col-sm-6 col-md-6">
  <label for="curso">Cusrso Escolar</label>
       ...
       <div class="col-sm-6 col-md-6">
            ...
            <div class="col-sm-6 col-md-6">
                        <a class="btn btn-success btn-block z-depth-2 mt-2" href="confirmalogalu.php?go=2" >Ver Todos</a>
           </div>
       </div>
